      ...
      <div className={styles.headerWrapper}>
        <nav className={styles.nav}>
          <div className={styles.navItem}>
            <div className={styles.navLink}>Streaming Movies & Shows</div>
            <div className={styles.badge} />
          </div>

          <div className={styles.navItem} onClick={getQuote}>
            <div className={styles.navLink}>On Air Exchange</div>
          </div>

          <div className={styles.navItem}>
            <div className={styles.navLink}>Streamers NFT</div>
            <div className={styles.badge} />
          </div>

          <div className={styles.navItem}>
            <div className={styles.navLink}>On Air News</div>
            <div className={styles.badge} />
          </div>
